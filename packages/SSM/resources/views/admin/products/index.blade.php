                        ...
                        <div class="symbol symbol-50px overflow-hidden me-3">
                            <a href="#">
                                <div class="symbol-label">
                                    <img src="{{ $product->image_url ?? 'https://placehold.co/50x50' }}" alt="{{ $product->name }}" class="w-100" />
                                </div>
                            </a>
                        </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="mb-3">
                                                ...
                                                <div class="image-input image-input-outline" style="background-image: url('{{ $product->image_url ?? 'https://placehold.co/150x150' }}')">
                                                    <img id="edit_preview_{{ $product->id }}" src="{{ $product->image_url ?? 'https://placehold.co/150x150' }}" class="image-input-wrapper w-125px h-125px" style="object-fit: cover;">
                                                </div>
                                            </div>
