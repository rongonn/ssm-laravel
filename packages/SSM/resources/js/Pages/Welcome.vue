...
const scrollHorizontally = (el: HTMLElement | null, direction: 'left' | 'right') => {
    if (el) {
        ...
        <div class="overflow-x-hidden">
                ...
                <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div class="max-w-2xl animate-in slide-in-from-left duration-1000">
                        <div class="flex items-center space-x-3 text-brand-200 mb-6 tracking-widest uppercase text-sm font-semibold bg-white/10 backdrop-blur-md w-fit px-5 py-2.5 rounded-2xl border border-white/20">
                            <img :src="LOGO_URL" class="h-6 w-auto object-contain" alt="" />
            ...
            <section class="py-24 bg-brand-50 overflow-hidden">
                <div class="max-w-7xl mx-auto px-4 mb-12 flex items-center justify-between">
                    ...
                    <div class="flex space-x-4">
                        <button @click="scrollHorizontally(serviceScrollRef, 'left')" class="p-4 rounded-full border border-slate-200 hover:bg-white text-slate-400 hover:text-brand-900 transition-all shadow-sm">
                            <ChevronLeft :size="24" />
                        </button>
                        <button @click="scrollHorizontally(serviceScrollRef, 'right')" class="p-4 rounded-full border border-slate-200 hover:bg-white text-slate-400 hover:text-brand-900 transition-all shadow-sm">
            ...
            <section class="py-24 bg-white overflow-hidden">
                <div class="max-w-7xl mx-auto px-4 mb-12 flex items-center justify-between">
                    ...
                    <div class="flex space-x-4">
                        <button @click="scrollHorizontally(productScrollRef, 'left')" class="p-4 rounded-full border border-slate-200 hover:bg-slate-50 text-slate-400 hover:text-brand-900 transition-all">
                            <ChevronLeft :size="24" />
                        </button>
                        <button @click="scrollHorizontally(productScrollRef, 'right')" class="p-4 rounded-full border border-slate-200 hover:bg-slate-50 text-slate-400 hover:text-brand-900 transition-all">
                            <ChevronRight :size="24" />
                        </button>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        <div class="h-64 overflow-hidden relative">
                            <img :src="product.image_url" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" :alt="product.name" />
