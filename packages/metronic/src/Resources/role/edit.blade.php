    ...
    <div class="row">
        ...
        <div class="col-12 mb-4">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <form action="{{ route(tenant() ? 'authorization.roles.update' : 'owner.authorization.roles.update', $role->id) }}" method="post"
                            id="role-form">
                            @csrf @method('PUT')
                        </form>
                        <div class="col-4 mb-2">
                            ...
                            <input name="title" form="role-form" type="text" class="form-control form-control-sm"
                                value="{{ $role->title }}" placeholder="ex. Sales Manager" required>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-12 mb-2">
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input form="role-form" type="checkbox" class="form-check-input h-20px w-30px permission-checkbox"
                                            ...
                                            value="{{ json_encode($route) }}" {{ in_array($route['permission'], $permissions)
                                            ? 'checked' : '' }}>
